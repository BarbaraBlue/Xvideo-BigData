...
# # Se busca en la pagina Xvideo: FORCED

# Inicializando la var de archivo con el nombre de la página a utilizar
paginaXVideos <- 'https://www.xvideos.com/?k=FORCED'
...
# Se genera una variable tipo, donde 3 es FORCED
Tipo <- list("3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3","3")
unlistTipo <- unlist(Tipo)

# Se genera una tabla con los datos obtenidos para FORCED
dfFORCED <- data.frame(LINKS= LinksXvideo, TITULO= textoXVideos, TIPO= unlistTipo, VISITAS= unlistVisitas, ME_GUSTA= unlistMe_Gusta, NO_ME_GUSTA= unlistNo_Me_Gusta)

# Almacenando la informacion en CSV
write.csv(dfFORCED, file="Tabla03.csv")
